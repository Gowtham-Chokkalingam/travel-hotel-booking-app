...
import { FormControlLabel, makeStyles, Radio, Button, FormControl, RadioGroup, CircularProgress } from "@material-ui/core";
        ...
        <div className="sorting">
          ...
          <div className="popular-filter">
            <FormControl component="fieldset">
              <RadioGroup aria-label="guest-rating" name="guest-rating" value={priceFilter} onChange={handleChange}>
